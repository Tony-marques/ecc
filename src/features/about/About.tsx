      ...
      <div className={styles.container}>
        ...
        <div className={styles.teamSection}>
          ...
          <div className={styles.teamPresentation}>
            <div className={styles.teamLeftColumn}>
              <div className={styles.teamMembers}>
                ...
                <div className={styles.member}>
                  ...
                  <p>
                    ...
                    détails afin de pouvoir transformer un séjour en une
          ...
          <div className={styles.serviceBlock}>
            ...
            <div className={styles.serviceContent}>
              <p>
                ...
                confiance, vous soulager et vous offrir une tranquillité
                d'esprit totale.
              </p>
        ...
        <div className={styles.signature}>
          <p>
            Parce que votre logement mérite la meilleure mise en valeur, et
            parce que vos voyageurs méritent une expérience qui dépasse leurs
            attentes, nous mettons du cœur dans chaque détail.
          </p>
          <FaHeart className={styles.heartIcon} />
          <p>
            C'est cette attention, cette rigueur et le mélange de nos passions
            qui font la signature <strong>Effet Coup de Cœur</strong>.
          </p>
        </div>
      </div>
    </div>
